...
class UI(customtkinter.CTk):
    ...
    def editPaths(self):
        ...
        def savePaths():
            paths["image_path"]=self.image_data_path.get()
            paths["image_save_path"]=self.image_save_path.get()
        ...
        self.image_data_path.insert(0, paths["image_path"])
        ...
        self.image_save_path.insert(0, paths["image_save_path"])
